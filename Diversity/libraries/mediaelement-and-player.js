	...
	$.extend(MediaElementPlayer.prototype, {
		buildvolume: function(player, controls, layers, media) {
			...
			handleVolumeMove = function(e) {
				...
				var volume = null,
					// DD modified:
					// an incorrect value of pageY was being set in the original script.
					totalOffset = $("html").hasClass("adapt-scrolling") ? volumeTotal[0].getBoundingClientRect() : volumeTotal.offset();
